...
local get_theme_colors = function(name)
	local ok1, default_theme = pcall(require, "theme.schemes." .. name)
	local _, user_theme = pcall(require, "schemes." .. name)
	return (ok1 and default_theme or user_theme).base16_palette
end
